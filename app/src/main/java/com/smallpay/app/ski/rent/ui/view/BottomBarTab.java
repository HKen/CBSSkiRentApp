package com.smallpay.app.ski.rent.ui.view;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon) {
        ...
        setBackgroundColor(getResources().getColor(R.color.tab_background_normal));
    }
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            setBackgroundColor(getResources().getColor(R.color.tab_background_select));
        } else {
